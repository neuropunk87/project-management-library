...
class TestCustomExceptions(unittest.TestCase):
    def test_project_not_found_error(self):
        with self.assertRaises(ProjectNotFoundError) as context:
            raise ProjectNotFoundError("Project not found. Please check the project name.")
    ...
    def test_task_not_found_error(self):
        with self.assertRaises(TaskNotFoundError) as context:
            raise TaskNotFoundError("Task not found in the project. Please check the task name.")
